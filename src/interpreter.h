...
enum class Command_code {
	NOTHING, CHANGE_RESOLUTION, CHANGE_SCALE, MOVE_PLAYER, RELOAD_LIGHT,
	GET_POSITION, SET_MUSIC_VOLUME, SET_SOUND_VOLUME, SET_PLAYER_MAX_HP,
	HEAL_PLAYER, DEAL_DAMAGE, SCALE_HP_BAR, SET_PLAYER_MOVE_SPEED,
	SET_PLAYER_JUMP_FORCE, DRAW_PLAYERS_COLLISION, DRAW_CHUNKS_BORDERS
};
