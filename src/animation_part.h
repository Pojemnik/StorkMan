...
public:
	Const_animation_part(std::array<const sf::Texture*, 3>* tex_) : tex(tex_){}
...
{
	const std::vector<const std::array<const sf::Texture*, 3>*> textures;
	const std::array<const sf::Texture*, 3>* current_tex;

public:
	Multi_texture_animtion_part(const std::vector<const std::array<const sf::Texture*, 3>*> textures_, int start = 0);
	const std::array<const sf::Texture*, 3>* const get_texture();
...
public:
	...
	virtual const std::array<const sf::Texture*, 3>* const get_texture();
