...
private:
	...
	static void print_incorrect_argument_error(std::string command, std::string what);
	...
	static bool get_bool(const Command& cmd, std::string var_name, std::array<std::string, 2> true_false_string);
	Console() {};
