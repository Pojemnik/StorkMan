...
def schody(x=0, y=0, warstwa=5, obrót=1, długość=2, wysokość=2, przesunięcie=0, stopnie=4, tekstura=podstawy.domyślna_tekstura, zwróć_tekst=False):
    ...
    if zwróć_tekst:
        ...
        podstawy.zapis(s)
def drabina_jednostronna(x=0, y=0, warstwa=5, obrót=1, podpórka=1, grubość=0.5, długość=6, szczeble=3, górny_margines=0, dolny_margines=0, głębokość=0.5, wysokość=0.5, tekstura_podpórki=podstawy.domyślna_tekstura, tekstura=podstawy.domyślna_tekstura, zwróć_tekst=False):
    s = ""
    if podpórka == 1:
        v = ["v",4]
        v += [0,0]
        ...
        v += [0,długość]
        s = s + podstawy.platforma(x=x,y=y,warstwa=warstwa,tekstura=tekstura_podpórki,wierzchołki=v,zwróć_tekst=True)
    if szczeble >= 2:
        v = ["v",4]
        v += [0,0]
        v += [głębokość*obrót,0]
...
def drabina_dwustronna(x=0, y=0, warstwa=5, naprzemienność=1, początek=0, lewe_przycięcie=0, prawe_przycięcie=0, lewa_podpórka=1, prawa_podpórka=1, grubość_lewej=0.5, grubość_prawej=0.5, długość=6, szczeble=3, rozpiętość=2, górny_margines=0, dolny_margines=0, głębokość=0.5, wysokość=0.5, tekstura_lewej_podpórki=podstawy.domyślna_tekstura, tekstura_prawej_podpórki=podstawy.domyślna_tekstura, tekstura=podstawy.domyślna_tekstura, zwróć_tekst=False):
    ...
    if lewa_podpórka == 1:
        ...
        s = s + podstawy.platforma(x=x,y=y,warstwa=warstwa,tekstura=tekstura_lewej_podpórki,wierzchołki=v,zwróć_tekst=True)
    if prawa_podpórka == 1:
        ...
        if prawe_przycięcie == 1:
            ...
            if początek == szczeble%2:
                v_y = (0,0,długość-dolny_margines-delta,długość-dolny_margines)
        v = ["v",4,v_x[0],v_y[0],v_x[1],v_y[1],v_x[2],v_y[2],v_x[3],v_y[3]]
        s = s + podstawy.platforma(x=x,y=y,warstwa=warstwa,tekstura=tekstura_prawej_podpórki,wierzchołki=v,zwróć_tekst=True)
    if szczeble >= 2:
...
def komnata(x=0, y=0, warstwa=5, wysokość=10, szerokość=10, tekstura=podstawy.domyślna_tekstura, grubość_górnej=0.5, grubość_dolnej=0.5, grubość_prawej=0.5, grubość_lewej=0.5, otwory_górne=[0,0], otwory_dolne=[0,0], otwory_prawe=[0,0], otwory_lewe=[0,0], zwróć_tekst=False):
    ...
    s = s + podstawy.platforma(x=x+szerokość-grubość_prawej,y=y,warstwa=warstwa,tekstura=tekstura,wierzchołki=v,zwróć_tekst=True)
    v = ["v",4,0,0,grubość_prawej,0,grubość_prawej,grubość_dolnej,0,grubość_dolnej]
    s = s + podstawy.platforma(x=x+szerokość-grubość_prawej,y=y+wysokość-grubość_dolnej,warstwa=warstwa,tekstura=tekstura,wierzchołki=v,zwróć_tekst=True)
    v = ["v",4,0,0,grubość_lewej,0,grubość_lewej,grubość_dolnej,0,grubość_dolnej]
    s = s + podstawy.platforma(x=x,y=y+wysokość-grubość_dolnej,warstwa=warstwa,tekstura=tekstura,wierzchołki=v,zwróć_tekst=True)
    ...
    for i in range(otwory_górne[0]):
        ...
        v = ["v",4,v_x[0],v_y[0],v_x[1],v_y[1],v_x[2],v_y[2],v_x[3],v_y[3]]
        s = s + podstawy.platforma(x=x+miejsce,y=y,warstwa=warstwa,tekstura=tekstura,wierzchołki=v,zwróć_tekst=True)
    ...
    for i in range(otwory_dolne[0]):
        ...
        v = ["v",4,v_x[0],v_y[0],v_x[1],v_y[1],v_x[2],v_y[2],v_x[3],v_y[3]]
        s = s + podstawy.platforma(x=x+miejsce,y=y+wysokość-grubość_dolnej,warstwa=warstwa,tekstura=tekstura,wierzchołki=v,zwróć_tekst=True)
    ...
    for i in range(otwory_lewe[0]):
        ...
        v = ["v",4,v_x[0],v_y[0],v_x[1],v_y[1],v_x[2],v_y[2],v_x[3],v_y[3]]
        s = s + podstawy.platforma(x=x,y=y+miejsce,warstwa=warstwa,tekstura=tekstura,wierzchołki=v,zwróć_tekst=True)
