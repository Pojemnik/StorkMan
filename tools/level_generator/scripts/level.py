...
#budynek generatora
struktury.komnata(x=6.5,y=0,warstwa=8,kolor=[128,128,128],szerokość=43.5,wysokość=48,grubość_prawej=1,grubość_lewej=1,grubość_górnej=1,grubość_dolnej=1,tekstura="bricks,0",tekstura_tła="asphalt,0",otwory_lewe=[3,8.5,3,27.5,3,43,3])
...
podstawy.platforma(x=44,y=43,tekstura="rivets,0",wierzchołki=["v",4,0,0,0.75,0,0.75,0.25,0,0.25],jednostronna=True,R=192,G=192,B=192)
podstawy.platforma(x=44.5,y=43.5,tekstura="rivets,0",wierzchołki=["v",4,0,0,0.75,0,0.75,0.25,0,0.25],jednostronna=True,R=192,G=192,B=192)
podstawy.platforma(x=45,y=44,tekstura="rivets,0",wierzchołki=["v",4,0,0,0.75,0,0.75,0.25,0,0.25],jednostronna=True,R=192,G=192,B=192)
podstawy.platforma(x=45.5,y=44.5,tekstura="rivets,0",wierzchołki=["v",4,0,0,0.75,0,0.75,0.25,0,0.25],jednostronna=True,R=192,G=192,B=192)
podstawy.platforma(x=46,y=45,tekstura="rivets,0",wierzchołki=["v",4,0,0,0.75,0,0.75,0.25,0,0.25],jednostronna=True,R=192,G=192,B=192)
podstawy.platforma(x=46.5,y=45.5,tekstura="rivets,0",wierzchołki=["v",4,0,0,0.75,0,0.75,0.25,0,0.25],jednostronna=True,R=192,G=192,B=192)
podstawy.platforma(x=44,y=43,tekstura="panels,1",wierzchołki=["v",4,0,0,3,3,2.85,3,0,0.15],jednostronna=True,R=128,G=128,B=128)
mechanizmy.dźwignia(x=42.5,y=41.75,zdarzenia=["PowerPlantOn","PowerPlantOff"],zdarzenia_wewnętrzne=["L11","L12","L13","L14"])
mechanizmy.dźwignia(x=48,y=44.5,zdarzenia=["PowerPlantOn","PowerPlantOff"],zdarzenia_wewnętrzne=["L21","L22","L23","L24"],obrót=-1,pozycja_początkowa=1)
...
struktury.element_podłużny(x=9.5,y=32.2,warstwa=6,tekstura="TEXVent_pipe",grubość=0.8,trasa=[7,2,-4.5,2,-1,0,1,0,2.5,1,3.5,32,3.5,32.5,3],kolizja=True)
...
struktury.element_podłużny(x=11.875,y=28,warstwa=5,tekstura="TEXSteel_stick",grubość=0.75,trasa=[2,0,0,0,7.3],kolor=[192,192,192])
