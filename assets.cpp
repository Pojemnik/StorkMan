...
void Assets::load_assets()
{
	...
	pieces[R_CALF].loadFromFile("img/stork/parts/LYDKA_ST_00.PNG");
	...
	pieces[R_FOREARM].loadFromFile("img/stork/parts/PRZEDRAMIE_ST_00.PNG");
	pieces[L_ARM].loadFromFile("img/stork/parts/RAMIE_ST_00.PNG");
	pieces[R_ARM].loadFromFile("img/stork/parts/RAMIE_ST_00.PNG");
